...
TOOLCHAIN_DIR=/home/marble/android-toolchain
echo $TOOLCHAIN_DIR

export SYSROOT=$TOOLCHAIN_DIR/sysroot

TARGET_CROSS=arm-linux-androideabi-
...
export GYP_DEFINES="OS=android host_os=linux libgcc=/home/marble/android-toolchain/lib/gcc/arm-linux-androideabi/4.9.x/libgcc.a"
