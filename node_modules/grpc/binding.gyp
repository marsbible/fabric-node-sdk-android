  ...
  'targets': [
    ...
    },
    {
      ...
      'conditions': [ 
         ...
         'actions': [
            {
              'action_name': 'static_lib',
              'inputs': [
                 "<(PRODUCT_DIR)/grpc_node.a",
                 "<(PRODUCT_DIR)/libgrpc.a",
                 "<(PRODUCT_DIR)/libgpr.a"
              ],
              'outputs': [
                  "<(PRODUCT_DIR)/libgrpc_node.a"
              ],
              'action': ['<(PRODUCT_DIR)/../gyp-mac-tool', 'filter-libtool', 'libtool', '-static', '-o', '<@(_outputs)', '<@(_inputs)']
            }
          ],
          "copies": [
            {
                 "files": [ "<(PRODUCT_DIR)/lib<(module_name).a"],
