...
export GYP_DEFINES="OS=android host_os=linux libgcc=/home/marble/android-toolchain64/lib/gcc/aarch64-linux-android/4.9.x/libgcc.a"

node-gyp rebuild --target=$NODE -v
cp build/Release/pkcs11.node binary/node-v57-android-arm64-unknown
