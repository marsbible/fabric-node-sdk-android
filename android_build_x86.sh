...
TOOLCHAIN_DIR=/home/marble/android-toolchain-x86
echo $TOOLCHAIN_DIR

export SYSROOT=$TOOLCHAIN_DIR/sysroot

TARGET_CROSS=i686-linux-android-
...
export GYP_DEFINES="OS=android host_os=linux libgcc=/home/marble/android-toolchain-x86/lib/gcc/i686-linux-android/4.9.x/libgcc.a"
#node-gyp rebuild --target=$NODE -v
#node-pre-gyp --target_platform=android --target_libc=unknown --target_arch=arm  --target=$NODE --build-from-source install --library=static_library
